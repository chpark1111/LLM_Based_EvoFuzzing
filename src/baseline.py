...
initial_inputs = ['cosh(cosh(cosh(cosh(cosh(9)))))', '(((cosh(4) * ((((acos(3) * tanh(3)) + sinh(cosh(3))) * -3) / acos(3))) / 4) / cosh(1))', '(acos(2) / acos(-8))', '(((cosh((5 * cosh((1 * 7)))) * 9) * 9) + 9)', 'ceil(tanh(acos(radians(asin(tanh(tanh(floor(log10(8)))))))))', 'log10((acos(2) / (-6 / acos(-4))))', '((asin((log10(-9) + acos((acos(8) * (acos(acos(1)) + 7))))) * asin(4)) - log(6))', 'log10(log(cosh(cosh(tanh(log10(cosh((log10(6) + log10(ceil(2))))))))))', 'floor(floor(tanh(acos((6 + cosh(asin(atan(7))))))))', '(asin((asin((8 - 9)) + ((3 - 3) - 9))) - (asin(1) * 3))', '((cosh(7) * 8) + sinh(8))', '(cosh(((asin(acos(-1)) * asin(4)) - (3 + tanh(tanh(((1 * 3) * 3)))))) - (1 + log(sinh(1))))', 'cosh(((cosh(((7 * cosh(2)) * (1 / cosh(7)))) + 9) + cosh(acos(cosh(cosh(1))))))', '((8 + 8) * ((9 * 2) / (acos(9) * 1)))', '(log10(7) + asin(asin(-4)))', 'log10(log10(tanh(acos(acos(floor(log10(log10((2 + 3)))))))))', '((-7 * (0 * 4)) * log10((5 * -4)))', '(((5 + 6) + (5 / 4)) / (5 + 5))', 'cosh((acos(acos(3)) / 3))', '((abs(sinh(cosh(-7))) - cos(fabs((radians(degrees(atan(9))) + -732)))) + 5)']
