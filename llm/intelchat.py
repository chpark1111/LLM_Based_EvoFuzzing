...
def mutatate_input_with_llm(user_input, num_gen=5):
    system_input = "You are a math expert assistant. Your mission is to help users generate various math equations.\
        Do not include any other words. Do not generate same equations. You must make various variations from the given one.\
        Generate %d equations (not same) like this: "%(min(10, num_gen))
